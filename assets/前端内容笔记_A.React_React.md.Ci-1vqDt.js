import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.Bb7nUynA.js";const k=JSON.parse('{"title":"React 入门","description":"","frontmatter":{},"headers":[],"relativePath":"前端内容笔记/A.React/React.md","filePath":"前端内容笔记/A.React/React.md"}'),e={name:"前端内容笔记/A.React/React.md"},l=p(`<h1 id="react-入门" tabindex="-1"><a class="header-anchor" href="#react-入门">React 入门</a></h1><h2 id="react-简介" tabindex="-1"><a class="header-anchor" href="#react-简介">React 简介</a></h2><h3 id="react-为何物" tabindex="-1"><a class="header-anchor" href="#react-为何物">React 为何物</a></h3><p>React：用于构建用户界面的 JavaScript 库。由 <code>Facebook</code> 开发且开源。</p><h3 id="为何学习-react" tabindex="-1"><a class="header-anchor" href="#为何学习-react">为何学习 React</a></h3><p>原生 JavaScript 的痛点：</p><ul><li>操作 DOM 繁琐、效率低</li><li>使用 JavaScript 直接操作 DOM，浏览器进行大量重绘重排</li><li>原生 JavaScript 没有组件化编码方案，代码复用率低</li></ul><p>React 的特点：</p><ul><li>采用组件化模式、声明式编码，提高开发效率和组件复用率</li><li>在 <code>React Native</code> 中可用 React 语法进行移动端开发</li><li>使用虚拟 DOM 和 Diffing 算法，减少与真实 DOM 的交互</li></ul><h2 id="react-初体验" tabindex="-1"><a class="header-anchor" href="#react-初体验">React 初体验</a></h2><h3 id="来一发-hello-react" tabindex="-1"><a class="header-anchor" href="#来一发-hello-react">来一发 Hello React</a></h3><p>相关 JS 库：</p><ul><li><code>react.development.js</code> ：React 核心库</li><li><code>react-dom.development.js</code> ：提供 DOM 操作的 React 扩展库</li><li><code>babel.min.js</code> ：解析 JSX 语法，转换为 JS 代码</li></ul><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">&lt;!-- 准备好一个“容器” --&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h3 id="创建虚拟-dom-的两种方式-js-和-jsx" tabindex="-1"><a class="header-anchor" href="#创建虚拟-dom-的两种方式-js-和-jsx">创建虚拟 DOM 的两种方式：JS 和 JSX</a></h3><ul><li>使用 JS 创建虚拟 DOM 比 JSX 繁琐</li><li>JSX 可以让程序员更加简单地创建虚拟 DOM，相当于语法糖</li><li>最终 babel 会把 JSX 语法转换为 JS</li></ul><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> type</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;text/javascript&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    //2.渲染虚拟DOM到页面</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ReactDOM.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">VDOM</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, document.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">getElementById</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;test&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">));</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h3 id="虚拟-dom-真实-dom" tabindex="-1"><a class="header-anchor" href="#虚拟-dom-真实-dom">虚拟 DOM &amp;&amp; 真实 DOM</a></h3><p>关于虚拟 DOM：</p><ol><li>本质是 Object 类型的对象（一般对象）</li><li>虚拟 DOM 比较“轻”，真实 DOM 比较“重”，因为虚拟 DOM 是 React 内部在用，无需真实 DOM 上那么多的属性。</li><li>虚拟 DOM 最终会被 React 转化为真实 DOM，呈现在页面上。</li></ol><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> type</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;text/babel&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    const</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> VDOM</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        &lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">h1</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> id</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;title&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">            &lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">span</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;Hello,React&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">span</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        &lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">h1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h2 id="jsx" tabindex="-1"><a class="header-anchor" href="#jsx">JSX</a></h2><h3 id="jsx-简介" tabindex="-1"><a class="header-anchor" href="#jsx-简介">JSX 简介</a></h3><ul><li>全称：JavaScript XML</li><li>React 定义的类似于 XML 的 JS 扩展语法；本质是 <code>React.createElement()</code> 方法的语法糖</li><li>作用：简化创建虚拟 DOM</li></ul><h3 id="jsx-语法规则" tabindex="-1"><a class="header-anchor" href="#jsx-语法规则">JSX 语法规则</a></h3><ul><li>定义虚拟 DOM 时，不要写引号</li><li>标签中混入 JS 表达式需要使用 <code>{}</code></li><li>指定类名不用 <code>class</code>，使用 <code>className</code></li><li>内联样式，使用 <code>style={ { key: value } }</code> 的形式</li><li>只能有一个根标签</li><li>标签必须闭合，单标签结尾必须添加 <code>/</code>：<code>&lt;input type=&quot;text&quot; /&gt;</code></li><li>标签首字母小写，则把标签转换为 HTML 对应的标签，若没有，则报错</li><li>标签首字母大写，则渲染对应组件，若没有定义组件，则报错</li></ul><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;!</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">DOCTYPE</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> html</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        ...</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        &lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> type</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;text/babel&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">            const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> myId</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;aTgUiGu&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">            const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> myData</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;HeLlo,rEaCt&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">            const</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> VDOM</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    &lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">body</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">html</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h3 id="jsx-例子" tabindex="-1"><a class="header-anchor" href="#jsx-例子">JSX 例子</a></h3><p>注意区分：<strong>JS 语句(代码)</strong> 与 <strong>JS 表达式</strong>：</p><ol><li>表达式：一个表达式会产生一个值，可以放在任何一个需要值的地方</li></ol><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">a;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    &lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ) ReactDOM.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">VDOM</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, document.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">getElementById</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;test&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">))</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div><h1 id="react-面向组件编程" tabindex="-1"><a class="header-anchor" href="#react-面向组件编程">React 面向组件编程</a></h1><h2 id="函数式组件" tabindex="-1"><a class="header-anchor" href="#函数式组件">函数式组件</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script type=&quot;text/babel&quot;&gt;</span></span>
...
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><p>要点：</p><ul><li>组件名称首字母必须大写，否则会解析成普通标签导致报错，详见 JSX 语法规则</li><li>函数需返回一个虚拟 DOM</li><li>渲染组件时需要使用标签形式，同时标签必须闭合</li></ul><p>渲染组件的过程：</p><ul><li>React 解析标签，寻找对应组件</li><li>发现组件是函数式组件，则调用函数，将返回的虚拟 DOM 转换为真实 DOM ，并渲染到页面中</li></ul><h2 id="类式组件" tabindex="-1"><a class="header-anchor" href="#类式组件">类式组件</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script type=&quot;text/babel&quot;&gt;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>  ReactDOM.render(&lt;Weather /&gt;, document.getElementById(&#39;test&#39;))</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h2 id="组件实例核心属性-props" tabindex="-1"><a class="header-anchor" href="#组件实例核心属性-props">组件实例核心属性 props</a></h2><p>每个组件对象都有 <code>props</code> 属性，组件标签的属性都保存在 <code>props</code> 中。</p><p><code>props</code> 是只读的，不能修改。</p><h3 id="props-基本使用" tabindex="-1"><a class="header-anchor" href="#props-基本使用">props 基本使用</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script type=&quot;text/babel&quot;&gt;</span></span>
...
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h3 id="批量传递-props" tabindex="-1"><a class="header-anchor" href="#批量传递-props">批量传递 props</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script type=&quot;text/babel&quot;&gt;</span></span>
<span class="line"><span>  class Person extends React.Component {</span></span>
<span class="line"><span>    render() {</span></span>
<span class="line"><span>      const { name, age, sex } = this.props</span></span>
<span class="line"><span>      return (</span></span>
...
<span class="line"><span>    console.log(&#39;speaking...&#39;)</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h3 id="类式组件的构造器与-props" tabindex="-1"><a class="header-anchor" href="#类式组件的构造器与-props">类式组件的构造器与 props</a></h3><p><a href="https://gitee.com/link?target=https%3A%2F%2Fzh-hans.reactjs.org%2Fdocs%2Freact-component.html%23constructor" target="_blank" rel="noreferrer">官网文档说明</a></p><p>构造函数一般用在两种情况：</p><ul><li>通过给 <code>this.state</code> 赋值对象来初始化内部 <code>state</code></li><li>为事件处理函数绑定实例</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>constructor(props) {</span></span>
<span class="line"><span>  super(props)</span></span>
<span class="line"><span>  // 初始化 state</span></span>
<span class="line"><span>  this.state = { isHot: true, wind: &#39;微风&#39; }</span></span>
<span class="line"><span>  // 解决 this 指向问题</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="函数式组件使用-props" tabindex="-1"><a class="header-anchor" href="#函数式组件使用-props">函数式组件使用 props</a></h3><p>由于函数可以传递参数，因此函数式组件可以使用 <code>props</code> 。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;!-- 引入prop-types，用于对组件标签属性进行限制 --&gt;</span></span>
<span class="line"><span>&lt;script type=&quot;text/javascript&quot; src=&quot;../js/prop-types.js&quot;&gt;&lt;/script&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;script type=&quot;text/babel&quot;&gt;</span></span>
...
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><h2 id="组件实例核心属性-refs" tabindex="-1"><a class="header-anchor" href="#组件实例核心属性-refs">组件实例核心属性 refs</a></h2><p>通过定义 <code>ref</code> 属性可以给标签添加标识。</p><h3 id="字符串形式的-ref" tabindex="-1"><a class="header-anchor" href="#字符串形式的-ref">字符串形式的 ref</a></h3><p>这种形式已过时，效率不高，<a href="https://gitee.com/link?target=https%3A%2F%2Fzh-hans.reactjs.org%2Fdocs%2Frefs-and-the-dom.html%23legacy-api-string-refs" target="_blank" rel="noreferrer">官方</a>不建议使用。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script type=&quot;text/babel&quot;&gt;</span></span>
...
<span class="line"><span>    )</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="受控-非受控组件" tabindex="-1"><a class="header-anchor" href="#受控-非受控组件">受控 &amp; 非受控组件</a></h2><p>包含表单的组件分类：</p><ul><li>非受控组件：现用现取。即需要使用时，再获取节点得到数据</li><li>受控组件：类似于 Vue 双向绑定的从视图层绑定到数据层</li></ul><p>尽量使用受控组件，因为非受控组件需要使用大量的 <code>ref</code> 。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 非受控组件</span></span>
...
<span class="line"><span>  &lt;/body&gt;</span></span>
<span class="line"><span>&lt;/html&gt;</span></span></code></pre></div><h2 id="样式的模块化" tabindex="-1"><a class="header-anchor" href="#样式的模块化">样式的模块化</a></h2><p>样式的模块化可用于解决样式冲突的问题。该方法比较麻烦，实际开发用的比较少。用 <code>less</code> 就能解决了。</p><p><code>component/Hello</code> 文件下的 <code>index.css</code> 改名为 <code>index.module.css</code> 。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>.title {</span></span>
...
<span class="line"><span>    })</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="消息订阅-发布机制" tabindex="-1"><a class="header-anchor" href="#消息订阅-发布机制">消息订阅-发布机制</a></h2><p>即 React 中兄弟组件或任意组件之间的通信方式。</p><p>使用的工具库：<a href="https://gitee.com/link?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Fpubsub-js" target="_blank" rel="noreferrer">PubSubJS</a></p><p>下载安装 <code>PubSubJS</code> ：<code>npm install pubsub-js --save</code></p><p>基础用法：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import PubSub from &#39;pubsub-js&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h1 id="react-路由" tabindex="-1"><a class="header-anchor" href="#react-路由">React 路由</a></h1><h2 id="路由的理解" tabindex="-1"><a class="header-anchor" href="#路由的理解">路由的理解</a></h2><p>何为路由？</p><ul><li>一个路由是一个映射关系</li><li><code>key</code> 为路径，<code>value</code> 可能是 <code>function</code> 或 组件</li></ul><p>后端路由：</p><ul><li><code>value</code> 是 <code>function</code> ，用于处理客户端的请求</li><li>注册路由：<code>router.get(path, function(req, res))</code></li><li>工作过程：Node 接收到请求，根据路径匹配路由，调用对应函数处理请求，返回响应数据</li></ul><p>前端路由：</p><ul><li><code>value</code> 是组件</li><li>注册路由：<code>&lt;Route path=&quot;/test&quot; component={Test}&gt;</code></li><li>工作过程：浏览器路径变为 <code>/test</code> ，展示 <code>Test</code> 组件</li></ul><h2 id="路由基本使用" tabindex="-1"><a class="header-anchor" href="#路由基本使用">路由基本使用</a></h2><p>安装 <code>react-router-dom</code> ：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 安装 5.X 版本路由</span></span>
...
<span class="line"><span>  url: &quot;/home/message/detail/2/hello&quot;</span></span></code></pre></div><h2 id="navlink-的使用" tabindex="-1"><a class="header-anchor" href="#navlink-的使用">NavLink 的使用</a></h2><p><code>NavLink</code> 可以实现路由链接的高亮，通过 <code>activeClassName</code> 指定样式名，默认追加类名为 <code>active</code> 。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;NavLink activeClassName=&quot;demo&quot; to=&quot;/about&quot;&gt;About&lt;/NavLink&gt;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>&lt;MyNavLink to=&quot;/home&quot;&gt;Home&lt;/MyNavLink&gt;</span></span></code></pre></div><h2 id="switch-的使用" tabindex="-1"><a class="header-anchor" href="#switch-的使用">Switch 的使用</a></h2><p><code>Switch</code> 可以提高路由匹配效率，如果匹配成功，则不再继续匹配后面的路由，即单一匹配。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;!-- 只会展示 Home 组件 --&gt;</span></span>
<span class="line"><span>&lt;Switch&gt;</span></span>
<span class="line"><span>  &lt;Route path=&quot;/about&quot; component=&quot;{About}&quot; /&gt;</span></span>
<span class="line"><span>  &lt;Route path=&quot;/home&quot; component=&quot;{Home}&quot; /&gt;</span></span>
<span class="line"><span>  &lt;Route path=&quot;/home&quot; component=&quot;{Test}&quot; /&gt;</span></span>
<span class="line"><span>&lt;/Switch&gt;</span></span></code></pre></div><h2 id="解决多级路径刷新页面样式丢失的问题" tabindex="-1"><a class="header-anchor" href="#解决多级路径刷新页面样式丢失的问题">解决多级路径刷新页面样式丢失的问题</a></h2><ul><li><code>public/index.html</code> 中 引入样式时不写 <code>./</code> 写 <code>/</code> （常用）</li><li><code>public/index.html</code> 中 引入样式时不写 <code>./</code> 写 <code>%PUBLIC_URL%</code> （常用）</li><li>使用 <code>HashRouter</code></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;link rel=&quot;stylesheet&quot; href=&quot;/css/bootstrap.css&quot; /&gt;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&lt;link rel=&quot;stylesheet&quot; href=&quot;%PUBLIC_URL%/css/bootstrap.css&quot; /&gt;</span></span></code></pre></div><h2 id="路由的严格匹配与模糊匹配" tabindex="-1"><a class="header-anchor" href="#路由的严格匹配与模糊匹配">路由的严格匹配与模糊匹配</a></h2><ul><li>默认使用模糊匹配（输入的路径必须包含要匹配的路径，且顺序一致）</li><li>开启严格匹配：<code>&lt;Route exact path=&quot;/about&quot; component={About}/&gt;</code></li><li>严格匹配需要再开，开启可能会导致无法继续匹配二级路由</li></ul><h2 id="redirect-的使用" tabindex="-1"><a class="header-anchor" href="#redirect-的使用">Redirect 的使用</a></h2><ul><li>一般写在所有路由注册的最下方，当所有路由都无法匹配时，跳转到 Redirect 指定的路由</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;Switch&gt;</span></span>
<span class="line"><span>  &lt;Route path=&quot;/about&quot; component=&quot;{About}&quot; /&gt;</span></span>
<span class="line"><span>  &lt;Route path=&quot;/home&quot; component=&quot;{Home}&quot; /&gt;</span></span>
<span class="line"><span>  &lt;Redirect to=&quot;/about&quot; /&gt;</span></span>
<span class="line"><span>&lt;/Switch&gt;</span></span></code></pre></div><h2 id="嵌套路由" tabindex="-1"><a class="header-anchor" href="#嵌套路由">嵌套路由</a></h2><ul><li>注册子路由需写上父路由的 <code>path</code></li><li>路由的匹配是按照注册路由的顺序进行的</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;!-- 父组件 --&gt;</span></span>
<span class="line"><span>&lt;MyNavLink to=&quot;/about&quot;&gt;About&lt;/MyNavLink&gt;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>const { name, age } = this.props.location.state</span></span></code></pre></div><h2 id="编程式导航" tabindex="-1"><a class="header-anchor" href="#编程式导航">编程式导航</a></h2><p>编程式导航是使用路由组件 <code>this.props.history</code> 提供的 API 进行路由跳转：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>this.props.history.push(path, state)</span></span>
...
<span class="line"><span>this.props.history.push(\`/home/message/detail\`, { id: id, title: title })</span></span></code></pre></div><h2 id="withrouter-的使用" tabindex="-1"><a class="header-anchor" href="#withrouter-的使用">withRouter 的使用</a></h2><p><code>withRouter</code> 的作用：加工一般组件，让其拥有路由组件的 API ，如 <code>this.props.history.push</code> 等。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import React, {Component} from &#39;react&#39;</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h2 id="优化写法" tabindex="-1"><a class="header-anchor" href="#优化写法">优化写法</a></h2><p><code>mapDispatchToProps</code> 可以写成对象形式，React-Redux 底层会帮助自动分发。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 函数写法</span></span>
...
<span class="line"><span>  default:</span></span>
<span class="line"><span>    return preState</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="纯函数" tabindex="-1"><a class="header-anchor" href="#纯函数">纯函数</a></h2><p>概念：输入同样的参数，返回同样的输出。</p><p>约束：</p><ul><li>不能修改参数数据</li><li>不产生任何副作用，如网络请求、输入和输出设备</li><li>不能调用 <code>Date.now()</code> 或 <code>Math.random()</code> 等不纯的方法</li></ul><p><code>reducer</code> 的函数必须是纯函数。</p><h2 id="redux-开发者工具" tabindex="-1"><a class="header-anchor" href="#redux-开发者工具">Redux 开发者工具</a></h2><p>Chrome 安装 Redux DevTools 开发者工具，项目下载依赖包 <code>npm i redux-devtools-extension --save-dev</code>，最后在 <code>store.js</code> 进行配置：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import { composeWithDevTools } from &#39;redux-devtools-extension&#39;</span></span>
<span class="line"><span>...</span></span>
...
<span class="line"><span>export default createStore(Reducers, composeWithDevTools())</span></span></code></pre></div><h2 id="项目打包运行" tabindex="-1"><a class="header-anchor" href="#项目打包运行">项目打包运行</a></h2><p>运行命令：<code>npm run build</code> 进行项目打包，生成 <code>build</code> 文件夹存放着打包完成的文件。</p><p>运行命令：<code>npm i serve -g</code> 全局安装 <code>serve</code> ，它能够以当前目录为根目录开启一台服务器，进入 <code>build</code> 文件夹所在目录，运行 <code>serve</code> 命令即可开启服务器查看项目效果。</p><h1 id="react-扩展内容" tabindex="-1"><a class="header-anchor" href="#react-扩展内容">React 扩展内容</a></h1><h2 id="setstate-更新状态的两种写法" tabindex="-1"><a class="header-anchor" href="#setstate-更新状态的两种写法">setState 更新状态的两种写法</a></h2><p>对象式：<code>setState(stateChange, [callback])</code></p><ul><li><code>stateChange</code> 为状态改变对象(该对象可以体现出状态的更改)</li><li><code>callback</code> 是可选的回调函数, 它在状态更新完毕、界面也更新后才被调用</li></ul><p>函数式：<code>setState(updater, [callback])</code></p><ul><li>updater 为返回 stateChange 对象的函数。</li><li>updater 可以接收到 state 和 props。</li></ul><p>说明：</p><ul><li>React 状态更新是异步的。下述代码打印的 <code>count</code> 值是上一次的值，而非更新后的。可在第二个参数回调中获取更新后的状态。</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>add = () =&gt; {</span></span>
...
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="路由组件懒加载-lazyload" tabindex="-1"><a class="header-anchor" href="#路由组件懒加载-lazyload">路由组件懒加载 lazyLoad</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import React, { Component, lazy, Suspense } from &#39;react&#39;</span></span>
...
<span class="line"><span>    )</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="react-hook" tabindex="-1"><a class="header-anchor" href="#react-hook">React Hook</a></h2><blockquote><p>Hook 是 React 16.8.0 增加的新特性，让我们能在函数式组件中使用 <code>state</code> 和其他特性</p></blockquote><h3 id="state-hook" tabindex="-1"><a class="header-anchor" href="#state-hook">State Hook</a></h3><ul><li><p><code>State Hook</code> 让函数式组件也可拥有 <code>state</code> 状态。</p></li><li><p>语法：<code>const [Xxx, setXxx] = React.useState(initValue)</code></p></li><li><p><code>useState()</code> 参数：状态初始化值；返回值：包含 2 个元素的数组，分别为状态值和状态更新函数</p></li><li><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>setXxx()</span></span></code></pre></div><p>的 2 种用法：</p><ul><li><code>setXxx(newValue)</code></li><li><code>setXxx(value =&gt; newValue)</code></li><li>注意！新状态值会<strong>覆盖</strong>原状态值！因此若有多个状态，只能多次调用 <code>React.useState</code> ，不能使用对象！</li></ul></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const [count, setCount] = React.useState(0)</span></span>
...
<span class="line"><span>    )</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="context" tabindex="-1"><a class="header-anchor" href="#context">Context</a></h2><p>Context 是一种组件间通信方式，常用于祖父组件与子孙组件。实际开发一般不用，一般用 React-Redux</p><p>用法说明：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1) 创建Context容器对象：</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>  ...</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="render-props-插槽" tabindex="-1"><a class="header-anchor" href="#render-props-插槽">render props (插槽)</a></h2><blockquote><p>类似于 Vue 中的插槽技术</p></blockquote><p>如何向组件内部动态传入带内容的结构（即标签或组件）？</p><ul><li>Vue：插槽技术</li><li>React： <ul><li>使用 <code>children props</code>：通过组件标签体传入结构</li><li>使用 <code>render props</code>：通过组件标签属性传入结构，可携带数据</li></ul></li></ul><p><code>children props</code> 方式：</p><ul><li>组件标签体内容会存储到 <code>this.props.children</code> 中</li><li>缺点：A 组件无法向 B 组件传递数据</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import React, { Component } from &#39;react&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="browserrouter" tabindex="-1"><a class="header-anchor" href="#browserrouter"><code>&lt;BrowserRouter&gt;</code></a></h2><p><code>&lt;BrowserRouter&gt; </code>用于包裹整个应用。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import ReactDOM from &#39;react-dom/client&#39;</span></span>
<span class="line"><span>import { BrowserRouter } from &#39;react-router-dom&#39;</span></span>
<span class="line"><span>import App from &#39;./App&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>ReactDOM.createRoot(document.getElementById(&#39;root&#39;)).render(</span></span>
...
<span class="line"><span>    &lt;App /&gt;</span></span>
<span class="line"><span>  &lt;/BrowserRouter&gt;</span></span>
<span class="line"><span>)</span></span></code></pre></div><h2 id="hashrouter" tabindex="-1"><a class="header-anchor" href="#hashrouter"><code>&lt;HashRouter&gt;</code></a></h2><p>作用与 <code>&lt;BrowserRouter&gt;</code> 一样，但 <code>&lt;HashRouter&gt;</code> 修改的是地址栏的 hash 值。</p><p>6.x 版本中 <code>&lt;HashRouter&gt;</code>、<code>&lt;BrowserRouter&gt;</code> 的用法与 5.x 相同。</p><h2 id="routes" tabindex="-1"><a class="header-anchor" href="#routes"><code>&lt;Routes/&gt;</code></a></h2><p>6 版本中移出了 <code>&lt;Switch&gt;</code>，引入了新的替代者：<code>&lt;Routes&gt;</code>。</p><p><code>&lt;Routes&gt;</code> 和 <code>&lt;Route&gt;</code> 要配合使用，且必须要用 <code>&lt;Routes&gt;</code> 包裹 <code>&lt;Route&gt;</code>。</p><h2 id="navigate-重定向" tabindex="-1"><a class="header-anchor" href="#navigate-重定向"><code>&lt;Navigate&gt;</code> 重定向</a></h2><p>只要 <code>&lt;Navigate&gt;</code> 组件被渲染，就会修改路径，切换视图。可用于路由重定向。</p><p><code>replace</code> 属性用于控制跳转模式（push 或 replace，默认是 push）。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import { NavLink, Routes, Route, Navigate } from &#39;react-router-dom&#39;</span></span>
<span class="line"><span>import About from &#39;./components/About/About&#39;</span></span>
<span class="line"><span>import Hello from &#39;./components/Hello/Hello&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default function App() {</span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="useroutes-路由表" tabindex="-1"><a class="header-anchor" href="#useroutes-路由表"><code>useRoutes()</code> 路由表</a></h2><p>路由规则可以单独抽出一个模块。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 路由表</span></span>
...
<span class="line"><span>&lt;NavLink to=&quot;home&quot; end &gt;home&lt;/NavLink&gt;</span></span></code></pre></div><h2 id="路由传参-1" tabindex="-1"><a class="header-anchor" href="#路由传参-1">路由传参</a></h2><blockquote><p>以不使用路由表为例</p></blockquote><h3 id="传递-params参数" tabindex="-1"><a class="header-anchor" href="#传递-params参数">传递 <code>params</code>参数</a></h3><p>注册路由时声明 <code>params</code> 参数，和 React Router 5 一样。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>export default function App() {</span></span>
<span class="line"><span>  return (</span></span>
<span class="line"><span>    &lt;div&gt;</span></span>
<span class="line"><span>      &lt;Routes&gt;</span></span>
<span class="line"><span>        &lt;Route path=&quot;hello&quot; element={&lt;Hello /&gt;}&gt;</span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="other-hooks" tabindex="-1"><a class="header-anchor" href="#other-hooks">Other Hooks</a></h2><h3 id="usematch" tabindex="-1"><a class="header-anchor" href="#usematch"><code>useMatch()</code></a></h3><p>返回路由组件的 <code>match</code> 数据，即 5 版本中的 <code>match</code> 属性。</p><p>必须传入该组件对应的路由规则才能正确返回，否则返回 <code>null</code>。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// Detail.jsx</span></span>
<span class="line"><span>import { useParams, useMatch } from &#39;react-router-dom&#39;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>export default function Detail() {</span></span>
...
<span class="line"><span>*/</span></span></code></pre></div><h3 id="useinroutercontext" tabindex="-1"><a class="header-anchor" href="#useinroutercontext"><code>useInRouterContext()</code></a></h3><p>如果组件在 <code>&lt;Router&gt;</code> 的上下文中呈现，则 <code>useInRouterContext</code> 钩子返回 <code>true</code>，否则返回 <code>false</code>。即组件有没有被包裹在 <code>&lt;BrowserRouter&gt;</code> 这种东西里面。这个对第三方组件库有用处。</p><h3 id="usenavigationtype" tabindex="-1"><a class="header-anchor" href="#usenavigationtype"><code>useNavigationType()</code></a></h3><p>返回当前的导航类型（用户是如何来到当前页面的）。</p><p>返回值：<code>POP</code>、<code>PUSH</code>、<code>REPLACE</code>。</p><p><code>POP</code> 是指在浏览器中直接打开了这个路由组件（刷新页面）。</p><h3 id="useoutlet" tabindex="-1"><a class="header-anchor" href="#useoutlet"><code>useOutlet()</code></a></h3><p>用来呈现当前组件中渲染的嵌套路由。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const result = useOutlet()</span></span>
<span class="line"><span>console.log(result)</span></span>
<span class="line"><span>// 如果嵌套路由没有挂载,则返回 null</span></span>
<span class="line"><span>// 如果嵌套路由已经挂载,则展示嵌套的路由对象</span></span></code></pre></div><h3 id="useresolvedpath" tabindex="-1"><a class="header-anchor" href="#useresolvedpath"><code>useResolvedPath()</code></a></h3><p>给定一个 URL 值，解析其中的：<code>path</code>、<code>search</code>、<code>hash</code> 值。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const res = useResolvedPath(&#39;/user?id=001&amp;name=Bruce#React&#39;)</span></span>
...
<span class="line"><span>*/</span></span></code></pre></div></div></div></div>`,88),t=[l];function i(c,o,d,r,h,u){return a(),n("div",null,t)}const m=s(e,[["render",i]]);export{k as __pageData,m as default};
